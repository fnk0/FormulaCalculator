 ...
 * @since 8/16/14.
 */
public class ParenthesisPrefs extends PreferenceFragment implements Preference.OnPreferenceChangeListener {

    private boolean mBindingPreference;
    private static String LOG_TAG = "ParenthesisPrefs";
